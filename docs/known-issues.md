...
| BUG-001 | Fixed awaiting retest | A defeated lead could re-enter at 0 HP; battle ownership was unclear and capture testing took four encounters. | Core capture loop was substantially degraded in 0.0.7. | Retest the 0.0.8 safe recovery and guaranteed 1-HP-plus-Snare capture path. |
